...
public class storico implements Serializable {
    ...
    public void init() 
    {
       ...
       {
    	   System.out.println("CODPOINT = "+codPoint);
    	   leggiAnalisi();
       }
    ...
    public void leggiAnalisi()
    {
		...
		List lst = genericLocalServiceUtil.genericQueryAsLocal(sSql,
				"analisiId,data_analisi,ora_analisi,tipo    ,temperatura_aria,temperatura_acqua,enterococchi,escherichia",
				"long     ,date        ,String     ,String  ,double          ,double           ,double      ,double     ");
		...
		sSql = "select b.codEx,b.codArea,b.nome,c.nome as provincia,d.nome as comune,b.codPoint from arpac_balneazione_point b "+ 
		...
		lst = genericLocalServiceUtil.genericQueryAsLocal(sSql,
				"codEx ,codArea,nome  ,provincia,comune,codPoint",
		...
		for (Object obj : lst)
		{
			...
			df.setValore(genericLocalServiceUtil.getStrAsLocal(arrayobject[5])+" ( ex "+genericLocalServiceUtil.getStrAsLocal(arrayobject[0])+")");
			lstDett.add(df);
